        ...
        <>
          ...
          {alerts.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-[50vh] text-center animate-fade-in">
              ...
              <h3 className="text-xl font-bold text-brand-text mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>No New Alerts</h3>
              <p className="text-sm text-brand-text-muted max-w-[260px] leading-relaxed" style={{ fontFamily: 'Manrope, sans-serif' }}>
                {t('no_alerts')}
              </p>
            </div>
          ) : (
